...
from endorse.flow123d_simulation import generate_time_axis
...
class MeasuredData:
    ...
    def plot_interp_data(self):
        ...
        fig_file = os.path.join("tsx_measured_data", "interp_data_TSX.pdf")
    ...
    def plot_all_data(self):
        ...
        fig.tight_layout()
        # plt.show()
        fig_file = os.path.join("tsx_measured_data", "measured_data_TSX.pdf")
        plt.savefig(fig_file)
    ...
    def read_chandler_data(self):
        # read Chandler data
        datafile1 = os.path.join("tsx_measured_data", "chandler_wpd_datasets_HGT1.csv")
        datafile2 = os.path.join("tsx_measured_data", "chandler_wpd_datasets_HGT2.csv")
    ...
    def read_rutquist_data(self):
        # read Rutquist data
        datafile = os.path.join("tsx_measured_data", "rutquist_wpd_datasets.csv")
    ...
    def read_zm_data(self):
        # read ZM data
        datafile = os.path.join("tsx_measured_data", "ZM_pressure.csv")
        borehole_names, data = self.read_csv_graph_data(datafile)
        # sorting and cropping data
        for bname, dat in data.items():
            v = np.array(dat["pressure"])
