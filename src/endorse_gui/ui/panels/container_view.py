...
class ContainerModel(QtCore.QAbstractItemModel):
    def __init__(self, container_list, parent=None):
    ...
    def data(self, index, role):
        ...
        if role == QtCore.Qt.DisplayRole:
            if index.column() == 0:
                return QtCore.QVariant(self._container_list[index.row()])
...
class ContainerView(QtWidgets.QWidget):
